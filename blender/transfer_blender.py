...
PATH_TO_PY_EXECUTABLE_WITH_SCIPY = r"C:\dev\3rd-party\maya-transfer-blend-shape\venv\Scripts\python.exe"
...
class Transfer(object):
    ...
    def execute(self, source_name:str = 'BASE_SOURCE'):
        ...
        dot = subprocess_dot(deformed_matrix_transpose, deformed_matrix)
